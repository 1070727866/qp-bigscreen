      ...
      <div class="bkDialog" >
        ...
        <div style="float: left;width: 580px">
          ...
          <div class="inlineBlockInput" v-if="whatDialog === 'carUpdateBk'">
            ...
            <SelectTemplate style="display: inline-block" selectName="车牌颜色" :list="bjzlList" :whatDialog="whatDialog" :updateDefalutValue="currentRow.hpysmc" />
          </div>
          ...
          <div class="inlineBlockInput" style="margin-top: 10px">
            ...
            <SelectTemplate selectName="布控类型" :list="bjzlList" :whatDialog="whatDialog" :updateDefalutValue="currentRow.bjzlmc"  />
          </div>
